        ...
        children: [
          Row(
            children: [
              ...
              if (heading?.isEmpty ?? true) const Spacer(),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: fillColor,
              borderRadius: BorderRadius.circular(borderRad ?? 15.r),
              border: showBorder
                  ? Border.all(
                      color: (errMsg?.isNotEmpty ?? false)
                          ? AppColor.errorColor
                          : borderColor ?? AppColor.greyColor.withOpacity(0.6),
                    )
                  : null,
            ),
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        prefixIconConstraints: BoxConstraints(maxHeight: 24.w),
